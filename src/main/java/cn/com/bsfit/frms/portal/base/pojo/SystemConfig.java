...
public class SystemConfig implements Serializable {
    private Integer id;// 系统配置ID,主键自动递增
    ...
    private Integer orderBy;// 排序字段，用于列表或下拽时的排序
	...
	public String toString() {
		return "SystemConfig [id=" + id + ", type=" + type + ", typeName=" + typeName + ", code=" + code + ", value="
				+ value + ", enabled=" + enabled + ", remark=" + remark + ", orderBy=" + orderBy + ", createTime="
